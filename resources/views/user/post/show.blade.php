...
@section('head')
    <link rel="canonical" href="{{route('user.post.show', [$post->slug])}}"/>
@endsection
                                ...
                                <div class="cat-item">
                                    <div class="cat-item__img">
                                        <picture>
                                            ...
                                            <img itemprop="image" src="{{asset('img/cat/ekonom.jpg')}}" alt="Эконом авто хундай">
                                        </picture>
                                    </div>
                                ...
                                <div class="cat-item">
                                    <div class="cat-item__img">
                                        <picture>
                                            ...
                                            <img itemprop="image" src="{{asset('img/cat/biz.jpg')}}" alt="Бизнес авто BMW">
                                        </picture>
                                    </div>
                                ...
                                <div class="cat-item">
                                    <div class="cat-item__img">
                                        <picture>
                                            ...
                                            <img itemprop="image" src="{{asset('img/cat/prem.jpg')}}" alt="Премиум авто Mercedes">
                                        </picture>
                                    </div>
                                ...
                                <div class="cat-item">
                                    <div class="cat-item__img">
                                        <picture>
                                            ...
                                            <img itemprop="image" src="{{asset('img/cat/cabrio.jpg')}}" alt="Кабриолет BMW">
                                        </picture>
                                    </div>
                                ...
                                <div class="cat-item">
                                    <div class="cat-item__img">
                                        <picture>
                                            ...
                                            <img itemprop="image" src="{{asset('img/cat/cross.jpg')}}" alt="Внедорожник Honda">
                                        </picture>
                                    </div>
                                ...
                                <div class="cat-item">
                                    <div class="cat-item__img">
                                        <picture>
                                            ...
                                            <img itemprop="image" src="{{asset('img/cat/ven.jpg')}}" alt="Минивэн Opel">
                                        </picture>
                                    </div>
