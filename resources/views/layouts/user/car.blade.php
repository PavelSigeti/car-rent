        ...
        <div class="row header-top__center">
            <div class="col-lg-2 col-6">
                <a href="/" class="logo-header__link">
                    <img src="{{ asset('img/svg/logo-black.svg') }}" alt="Logo Foxrent" class="logo-img">
                </a>
            </div>
            ...
            <div class="col-lg-2 header-phone hide-992"><a href="tel:{{$settings['phone_link']->value}}">{{$settings['phone']->value}}</a></div>
